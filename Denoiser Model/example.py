from Noiser_MT import Dataset_Builder, Writer, joiner, information_extractor
...
Dataset=Dataset_Builder(batch_size, image_size, Load_path, silence=False) #images_per_thread=???
